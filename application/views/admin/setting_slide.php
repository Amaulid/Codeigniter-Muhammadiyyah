            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td><?php echo $no++ ?></td>
                  <td>
          			  <img style="width: 100px" src="<?= base_url().'/upload/'.$sld->file ?>" >
         		  </td>
              <td><?= $sld->deskripsi  ?> </td>
         		  <td onclick="javascript: return confirm('Anda Yakin Hapus?')"><?php echo anchor('admin/slide/hapus/' .$sld->id_slide, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></div>') ?>
         		  </td>                
                </tr>
