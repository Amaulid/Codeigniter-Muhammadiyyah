...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url() ?>assets/img/galeri/logo.jpg">
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>assets_admin/dist/css/skins/skin-blue.min.css">
